...
<div class="adminMain_right">
	<div class="memberListBox_main">
		<div class="memberListBox_mainTop">
			회원 목록
		</div>
		<table>
			<tr class="memberListBox_mainTit">
			...
			for(Member m:list){ 
			%>
			<tr class="memberListBox_mainCon">
				...
				<td>
					<fmt:formatDate value="<%=m.getMemberEnrolldate()%>" pattern="yyyy년 MM월 dd일" />
				</td>
			</tr>
			<%} }else{%>
			<tr>
