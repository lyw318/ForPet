...
<%@ include file="/WEB-INF/views/myPage/myPageCommon.jsp" %>
	...
	<div class="myPageMain_right">
		...
		<form name="petUpdateFrm" action="${pageContext.request.contextPath}/pet/petUpdateEnd.do" method="post" onsubmit="return validate();" enctype="multipart/form-data">
					
 			<div class="memberImageBox">
					<div class="memberImage">
						<div class="inputBackground" id="image_section">
							<div>
								<img src="${pageContext.request.contextPath}/resources/upload/petProfile/${pet.petRenamedImage}" class="fileUploadIcon" width="100px" height="100px"/><br/>
			...
			<div class="petForm">
				<label>반려동물명<input type="text" class="form-control" value="${pet.petName}" name="petName" id="petName" required></label><br/>
				...
				<input type="text" class="form-control" placeholder="상세품종을 적어주세요" value="${pet.petType2 }" name="petType2" id="petType2" required><br/>
				</label>		
				<label>탄생일
				<input type="date" class="form-control" name="petBirth" value="${pet.petBirth }" /><br/>
				</label>
			</div> 
			...
			<input type="button" class="btn btn-outline-success" onclick="fn_del();" value="삭제">
